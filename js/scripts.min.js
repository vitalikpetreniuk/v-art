...
function loadScripts()
{
	...
	$('body').on('click', '.vart-head-tabs li a', function(e){
		e.preventDefault();
	...
	$('body').on('click', '.ca-artwork-tablist ul.tablist li a', function(e){
		e.preventDefault();
		e.stopPropagation();
	...
	if($('.chapter-artwork_visual').length && $('.chapter-artwork_visual video').length)
	{
		$('.chapter-artwork_visual').addClass('video');
		$('.visual-lightbox .visual-image').addClass('video');
	}
	...
	$('body').on('click', '.chapter-artwork_visual button', function(){
		...
		if($('.chapter-artwork_visual').hasClass('video'))
		{
			$('.chapter-artwork_visual video')[0].play();
		}
	})
	$('body').on('click', '.chapter-artwork_visual .vn-fullscreen', function(){
		...
		if($('.chapter-artwork_visual').hasClass('video'))
		{
			currentTime = $('.chapter-artwork_visual video')[0].currentTime;
			$('.chapter-artwork_visual video')[0].pause();
			$('.visual-lightbox video')[0].currentTime = currentTime;
			$('.visual-lightbox video')[0].play();
		}
	})
	$('body').on('click', '.visual-lightbox-close, .visual-fullscreen.collapse', function(){
		$('body').removeClass('visual-lightbox-onscreen');
		if($('.chapter-artwork_visual').hasClass('video'))
		{
			currentTime = $('.visual-lightbox video')[0].currentTime;
			$('.visual-lightbox video')[0].pause();
			$('.chapter-artwork_visual video')[0].currentTime = currentTime;
			$('.chapter-artwork_visual video')[0].play();
		}
	})
	...
	if($('.ch-at-tags').length)
	{
		...
		$('body').on('click', '.ch-at-tags .current-tag', function(){
		...
		$('body').on('click', '.ch-at-tags .ch-at-tags-list li', function(){
	...
	{
		$('body').on('click', '.chapters-list li a', function(e){
